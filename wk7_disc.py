...
def passFunction():
        ...
        def passGenFunction():
            ...
            # Actual password generating function and requirements checker
            def passCheck():
                ...
                for i in range(times):
                    ...
                    while True:
                        ...
                        # Check for special characters
                            ...
                            break
                        # How to handle the failure flag
                        if flag == -1:
                            print("Not a valid password:")
                            print(password + "\n")
                            return passCheck() # Return to checker function to generate new passwords
            passCheck()
